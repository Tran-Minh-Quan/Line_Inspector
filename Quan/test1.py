    ...
    if THKersize % 2 == 0 or OpKerSize % 2 == 0 or ErsKerSize%2 == 0:
      ...
      if ret == True:
        ...
        opening_kernel = np.ones((OpKerSize, OpKerSize), np.uint8)
          ...
          #pass
        #else:
        th = cv2.adaptiveThreshold(frame1,255 , cv2.ADAPTIVE_THRESH_GAUSSIAN_C,cv2.THRESH_BINARY_INV, THKersize, C)
...
testthreshold(winName='Test trackbar',cam='VIDEO_capture_13.avi')
